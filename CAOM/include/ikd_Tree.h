...
//
// Copied From MARS https://github.com/hku-mars/ikd-Tree/blob/main/ikd-Tree/ikd_Tree.cpp
//

#ifndef STRUCTURAL_MAPPING_IKD_TREE_H
#define STRUCTURAL_MAPPING_IKD_TREE_H
...
#endif //STRUCTURAL_MAPPING_IKD_TREE_H
