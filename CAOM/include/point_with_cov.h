//
// Created by cyz on 2023/4/2.
//

#ifndef STRUCTURAL_MAPPING_POINT_WITH_COV_H
#define STRUCTURAL_MAPPING_POINT_WITH_COV_H
...
namespace pcl
{
    ...
    struct PointXYZIWithCov : public _PointXYZIWithCov
    {
        ...
        inline PointXYZIWithCov(const pcl::PointXYZINormal &p, const Eigen::Matrix3f &cov_matrix)
        {
            x = p.x;
            y = p.y;
            z = p.z;
...
POINT_CLOUD_REGISTER_POINT_STRUCT(pcl::_PointXYZIWithCov,
                                  (float, x, x)(float, y, y)(float, z, z)(float, intensity, intensity)(float, cov_vec[0], cov_xx)(float, cov_vec[1], cov_xy)(float, cov_vec[2], cov_xz)(float, cov_vec[3], cov_yy)(float, cov_vec[4], cov_yz)(float, cov_vec[5], cov_zz)(float, cov_trace, cov_trace))
...
#endif //STRUCTURAL_MAPPING_POINT_WITH_COV_H
